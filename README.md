...
Apache POI: Para la generación de reportes financieros en Excel.

Apache Commons Email: Para la conexión SMTP y envío de correos.

Logback: Para la trazabilidad y auditoría de eventos en consola.
...
El sistema cuenta con datos precargados para facilitar su evaluación técnica y revisión de interfaces.
